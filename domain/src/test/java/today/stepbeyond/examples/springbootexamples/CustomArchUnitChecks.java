...
public class CustomArchUnitChecks {
    ...
    public static DescribedPredicate<JavaAnnotation> anyAnnotationElseThan(List<Class<? extends Annotation>> clazzes) {
    ...
    private static class AnyAnnotationElseThan extends DescribedPredicate<JavaAnnotation> {
        ...
        public boolean test(JavaAnnotation javaAnnotation) {
            return annotations.stream()
                    ...
                    .noneMatch(annotationName -> annotationName.equals(javaAnnotation.getType().toErasure().getName()));
        }
    }
}
